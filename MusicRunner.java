...
public class MusicRunner
{
  public static void main (String[] args)
  {
    ...
    String[] data = mr.getSongData();  // Get next line of song data
    ...
    while (data != null)
    {
      ...
      if (data[2].equals("song"))
      {
        ...
        System.out.println("The song \"" + song.name + "\" was sung by the lovely artist \"" + song.artist + "\" way back in the year " + song.year);
